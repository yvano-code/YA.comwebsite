...
def process_image(input_path, output_path):
    ...
    # The laurels are black, so luminance is near 0. Background is white, luminance near 255.
    # Enhance the alpha map for popping effect (make edges sharper)
...
process_image("public/projects/bbt_laurels.webp", "public/projects/bbt_laurels_transparent.png")
