...
bpy.ops.object.effector_add(type='WIND', location=(-1, 0, 0), rotation=(0, math.radians(90), 0))
...
psettings.use_hair_dynamics = True

# Bake to frame 30 to get wind effect
...
bpy.ops.object.camera_add(location=(0, 0, 3.2), rotation=(0, 0, 0))
cam = bpy.context.active_object
bpy.context.scene.camera = cam

out_path = "/Users/bebrilliant/Documents/antigravity/YA.comwebsite/public/test_wind_A.png"
bpy.context.scene.render.filepath = out_path
bpy.ops.render.render(write_still=True)
print("Rendered wind test to", out_path)
"""
