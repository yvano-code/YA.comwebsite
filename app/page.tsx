  ...
  return (
    <div className="mx-auto w-full max-w-[1400px] px-4 md:px-12">
      ...
      <div className="w-full text-center mt-2 mb-6 text-[8px] sm:text-[10px] text-[#8c8c8c] font-medium tracking-[0.2em] uppercase">
        FOR BOOKINGS, COLLABORATIONS, AND GENERAL INQUIRIES. SEND A MESSAGE VIA THE CONTACT FORM OR EMAIL DIRECTLY: <span className="font-semibold text-[#666]">YWICKHAMEDWARDS@GMAIL.COM</span>
      </div>
