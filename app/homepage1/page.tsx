  ...
  return (
    <div className="min-h-screen pb-24">
      ...
      <nav className="flex items-center justify-between px-6 md:px-12 pt-8 pb-4 text-sm font-semibold tracking-wide">
         <div>
            <Link href="/" className="bg-white text-black px-5 md:px-6 py-2.5 md:py-3 rounded-full text-[10px] md:text-xs font-bold uppercase tracking-widest hover:bg-gray-200 transition whitespace-nowrap border border-black/10">Go to Homepage 2</Link>
         </div>
         <div>
      ...
      <header className="relative flex flex-col items-center justify-center pt-24 md:pt-56 pb-32 md:pb-56 text-center w-full">
        ...
        <section className="mt-8 md:mt-12 px-6 md:px-12 pb-12 border-t border-black/10 pt-16 md:pt-24">
          ...
          <div className="w-full flex flex-col items-center pt-8 pb-8 gap-8 md:gap-12">
            <Image 
              ...
              height={600}
              unoptimized={true}
              className="w-full h-auto object-contain contrast-125 grayscale scale-[0.98]"
            />
          </div>
        </section>
      </main>
