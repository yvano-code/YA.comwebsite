  ...
  return (
    <div className="md:hidden fixed bottom-6 left-0 right-0 z-[100] flex justify-center pointer-events-none">
      ...
      >
        ...
        <div className="flex items-center justify-center gap-2 p-2 px-4 bg-black/40 backdrop-blur-[40px] border border-white/20 rounded-full shadow-[0_16px_40px_rgba(0,0,0,0.3),inset_0_1px_2px_rgba(255,255,255,0.2)] saturate-[1.2]">
        ...
        <Link 
          href="/"
          className="flex items-center justify-center w-[55px] h-[55px] transition-all duration-300 rounded-full hover:bg-white/10"
        >
