      ...
      {projects.map((project, idx) => {
        ...
        return (
          ...
          >
            ...
            <div className="w-full h-full relative rounded-[40px] overflow-hidden group border border-white/10 shadow-2xl">
              <Image 
              ...
              <div className="absolute top-8 right-8 lg:top-12 lg:right-12 flex items-center gap-6 z-10">
                <div 
