...
export function AwardsSection({ children }: { children?: React.ReactNode }) {
    ...
    <div className="w-full relative flex flex-col pt-16 md:pt-24 pb-0 bg-transparent">
      ...
      <section className="w-full pt-8 relative z-10">
        <div className="px-6 flex flex-col md:flex-row items-start md:items-end gap-6 lg:gap-12 mb-8 lg:mb-16">
          <h3 className="text-3xl md:text-4xl lg:text-[60px] font-semibold tracking-wide uppercase leading-[1.1] text-black" style={{ fontFamily: 'var(--font-oswald), sans-serif' }}>
            Credits & Filmography
          </h3>
      ...
      <section className="lg:hidden px-6 md:px-12 pt-16 pb-16 relative z-10">
        <h3 className="text-3xl md:text-4xl lg:text-[60px] font-semibold tracking-wide uppercase leading-[1.1] text-black mb-8" style={{ fontFamily: 'var(--font-oswald), sans-serif' }}>
            Awards & Official Selections
        </h3>
