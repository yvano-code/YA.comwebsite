...
export const siteConfig = {
  ...
  imdbDirectorStatement: "In 1976, photojournalist Stanely Forman captured a dramatic moment at a protest;\nThe Soiling of Old Glory.\nI found the photo while researching the Pulitzer Prizes.\nSee for yourself.\n\nTo a photojournalist the intention is truth.\nUnfiltered and unscripted.\n\nTruth to a filmmaker is created.\nMise en scene.\nIntention here is deliberate.\nCareful and unhurried.\nWe’re encouraged to select an appropriate medium for the message.\n\nMy work is deliberate and unfiltered.\nI intend to be careful in my selection and unhurried by capitalism.",
