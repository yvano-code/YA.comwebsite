...
export const siteConfig = {
  ...
  imdbDirectorStatement: "Before I ever picked up a camera with any sort of intention, I learned a valuable lesson about the power of photography from a photograph.\n\nIn 1976, photojournalist Stanely Forman captured a very dramatic moment at a protest. He called it the Soiling of Old Glory. See for yourself. I found the photo while researching the Pulitzer Prizes. That moment was where it all started.\n\nIt set me on a path. I followed that path through college as a photojournalist capturing Black Lives Matter protests. As a set photographer capturing stills on documentaries around the world. And now as a director crafting their first feature film.\n\nI learned that intention should be paramount to an artist. As a photojournalist, the intention is truth. Unfiltered and unscripted. Truth to a filmmaker, is created. Mise en scene (staged). Intention here is deliberate. Careful and unhurried. We’re encouraged to select the right medium for the message.\n\nMy work is deliberate and unfiltered. I intend to be careful in my selection and unhurried by capitalism.",
