...
for char in letters:
    ...
    if principled:
        # Bright pink
        principled.inputs["Base Color"].default_value = (0.95, 0.5, 0.65, 1.0)
    ...
    # Fake Wind by tilting
    text_obj.rotation_euler = (math.radians(-5), math.radians(8), 0)
